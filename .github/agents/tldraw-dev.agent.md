...
5. **Test in Docker**: Build and test changes in a Docker container for reproducibility
6. **Clean up**: Remove dangling images/containers to free resources
7. **Verify**: Confirm the app starts and core functionality works
